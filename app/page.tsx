      ...
      <main className="flex-1">
        ...
        <section className="container py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed text-balance">
              私たちは、ボードゲームを愛する仲間が集まるサークルです。 毎週楽しくゲームを楽しんでいます。
            </p>
          </div>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                ...
                <CardContent>
                  <img
                    src="/board-game-session-on-weekend.jpg"
                    alt="週末ゲーム会"
                    className="w-full h-48 object-cover rounded-lg mb-4"
                  />
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    定番ゲームから新作まで、自由に遊べるゲーム会です。
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <img
                    src="/beginners-learning-board-games.jpg"
                    alt="初心者向け体験会"
                    className="w-full h-48 object-cover rounded-lg mb-4"
                  />
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    ボードゲーム初心者向けに、ルールから丁寧に教えます。
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <img
                    src="/board-game-tournament-competition.jpg"
                    alt="大会イベント"
                    className="w-full h-48 object-cover rounded-lg mb-4"
                  />
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    人気ゲームの大会を開催。盛り上がること間違いなし！
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-2">
                    <p className="text-sm leading-relaxed">
                      駅から近く、広々とした会議室で快適に遊べます。週末は主にこちらで活動しています。
                    </p>
                  </div>
                </CardContent>
              </Card>
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container text-center">
            ...
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto leading-relaxed text-balance">
              見学や体験参加も大歓迎です。お気軽にご連絡ください。
            </p>
